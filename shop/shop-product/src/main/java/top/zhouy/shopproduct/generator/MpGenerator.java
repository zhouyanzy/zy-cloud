package top.zhouy.shopproduct.generator;
...
public class MpGenerator {
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir(oPath + "/shop/shop-product/src/main/java");   //生成文件输出根目录
        ...
        dsc.setUrl("jdbc:mysql://47.101.151.43:3306/shop-product?useUnicode=true&characterEncoding=utf8&characterSetResults=utf8&serverTimezone=GMT%2B8");  //指定数据库
        autoGenerator.setDataSource(dsc);

        // 策略配置
        StrategyConfig strategy = new StrategyConfig();
        strategy.setNaming(NamingStrategy.underline_to_camel);      // 表名生成策略
        strategy.setInclude(new String[] { "shop_category", "shop_product", "shop_sku", "shop_product_category" });     // 需要生成的表
        ...
        pc.setParent("top.zhouy.shopproduct");
