...
public class MpGenerator {
    ...
    public static void main(String[] args) {
        ...
        // 生成文件输出根目录
        gc.setOutputDir(oPath + "/shop/shop-home/src/main/java");
        // 生成完成后不弹出文件框
        gc.setOpen(false);
        // 文件覆盖
        ...
        // 指定数据库
        dsc.setUrl("jdbc:mysql://47.101.151.43:3306/shop-home?useUnicode=true&characterEncoding=utf8&characterSetResults=utf8&serverTimezone=GMT%2B8");
        ...
        // 需要生成的表
        strategy.setInclude(new String[] { "shop_home_model", "shop_home_model_detail", "shop_img_config" });
