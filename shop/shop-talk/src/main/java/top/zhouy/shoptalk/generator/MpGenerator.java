...
public class MpGenerator {
    ...
    public static void main(String[] args) {
        ...
        // 生成文件输出根目录
        gc.setOutputDir(oPath + "/shop/shop-talk/src/main/java");
        // 生成完成后不弹出文件框
        gc.setOpen(false);
        // 文件覆盖
        ...
        // 指定数据库
        dsc.setUrl("jdbc:mysql://47.101.151.43:3306/shop-talk?useUnicode=true&characterEncoding=utf8&characterSetResults=utf8&serverTimezone=GMT%2B8");
