package top.zhouy.shoptalk.generator;
...
public class MpGenerator {
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir(oPath + "/shop/shop-talk/src/main/java");   //生成文件输出根目录
        ...
        dsc.setUrl("jdbc:mysql://47.101.151.43:3306/shop-talk?useUnicode=true&characterEncoding=utf8&characterSetResults=utf8&serverTimezone=GMT%2B8");  //指定数据库
        ...
        pc.setParent("top.zhouy.shoptalk");
